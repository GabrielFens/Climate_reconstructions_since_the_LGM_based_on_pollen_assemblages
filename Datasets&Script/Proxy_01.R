...
print(crest_ex)
print(crest_pse)
rcnstrct<-crest.get_modern_data(df=crest_ex,climateWithObs=TRUE,pse=crest_pse,taxaType=1,climate=c('bio1','bio12'),xmn=10,xmx=140,ymn=50,ymx=90,continents='Europe',minGridCells=20,site_info=c(47.81,6.51),dbname='gbif4crest_02-5min.sqlite3',verbose='TRUE')
